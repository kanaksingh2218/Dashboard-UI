    ...
    <section className="solutions-section">
      <div className="solutions-inner">
        ...
        <div className="solutions-features">
          ...
          <FeatureCard 
            iconSrc="/src/assets/cb7-icon.png"
          ...
          <FeatureCard 
            iconSrc="/src/assets/nbfc-icon.png"
          ...
          <FeatureCard 
            iconSrc="/src/assets/nbfc-icon-2.png"
